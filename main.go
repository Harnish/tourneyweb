...
func main() {
	...
	router.GET("/tournaments/:tid/teams/:teamid/gc-qr.png", wh.TeamGameChangerQR)
	...
	router.POST("/tournaments/:tid/manage/teams/:teamid/roster/gamechanger", wh.RosterSetGameChanger)
	...
	router.GET("/tournaments/:tid/manage/teams/:teamid/roster/players/:pid/edit", wh.RosterEdit)
	router.POST("/tournaments/:tid/manage/teams/:teamid/roster/players/:pid/edit", wh.RosterEdit)
	router.POST("/tournaments/:tid/manage/teams/:teamid/roster/players/:pid/delete", wh.RosterDelete)
